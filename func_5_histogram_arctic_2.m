function[XL,list_nonNan]=func_5_histogram_arctic_2(MLC_classification, index, station, Njan, Nfeb, Nmar, Napr, Nmay, Njun, Njul, Naug, Nseb, Noct, Nnov, Ndec, ic)

Evaluation_4_RC_calc_2 
...
%NaN:
% mon_Nan=periode(idx_Nan);           
% [a_Nan,b_Nan]=hist(mon_Nan,unique(mon_Nan));
% list_Nan(1:maxlist)=NaN;
...
noML1_nonNan=list_noML1./a; %list_nonNan; 
cloud1_nonNan=list_1cloud./a; %list_nonNan; 
noML0_nonNan=list_noML0./a;%list_nonNan; 
